...
public class Grafo {
    ...
    public void eliminarArista(int i, int j){//por hacer
        if (existeArista(i, j)) { 
        ...
        JOptionPane.showMessageDialog(null, "Amistad eliminada correctamente");
    }
    ...
    public  Lista<Adyacente> adyacentesDe(int i) {
        return adyacentes[i];
    }
	...
	if(newIndex == adyacentes.length) {duplicarArray();System.out.println("Algo");}
